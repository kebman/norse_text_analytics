# Norse Text Analytics Docs

Primary documentation hub for architecture, ingest, schema, and query usage.
...
- [IDs and References](ids-and-references.md)
- [Ingest Overview](ingest/ingest-overview.md)
- [Adapter Contract](ingest/adapter-contract.md)
